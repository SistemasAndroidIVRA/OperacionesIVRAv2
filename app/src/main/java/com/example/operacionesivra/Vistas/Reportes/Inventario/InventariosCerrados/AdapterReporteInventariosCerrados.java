package com.example.operacionesivra.Vistas.Reportes.Inventario.InventariosCerrados;
...
import com.example.operacionesivra.Vistas.Inventario.InventariosCerrados.ModeloInventariosCerrados;
...
public class AdapterReporteInventariosCerrados extends RecyclerView.Adapter<AdapterReporteInventariosCerrados.ViewHolder> {
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    new MaterialAlertDialogBuilder(contexto)
                            ...
                            .setPositiveButton("Reporte", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    Intent intent = new Intent(contexto, ReporteInventarioTerminado.class);
                                    intent.putExtra("folio",folio);
                                    contexto.startActivity(intent);
                                    if(contexto instanceof ReporteInventariosCerrados){
                                        ((ReporteInventariosCerrados)contexto).finish();
                                    }
    ...
    public  AdapterReporteInventariosCerrados (List<ModeloInventariosCerrados> lista) {
