package com.example.operacionesivra.Vistas.Pedidos;
...
import com.example.operacionesivra.Vistas.Pedidos.Ventas.Ventas;
...
public class Pedidos extends AppCompatActivity {
    ...
    ArrayList<SerieModel> arraySeries = new ArrayList<>();
