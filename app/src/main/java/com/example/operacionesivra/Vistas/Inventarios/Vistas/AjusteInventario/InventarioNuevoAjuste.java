package com.example.operacionesivra.Vistas.Inventarios.Vistas.AjusteInventario;
...
import com.example.operacionesivra.Modelos.AjusteDetailsModel;
import com.example.operacionesivra.Modelos.AjusteModel;
import com.example.operacionesivra.Modelos.AlmacenModel;
import com.example.operacionesivra.Modelos.Producto;
import com.example.operacionesivra.Modelos.SerieModel;
import com.example.operacionesivra.Modelos.UnidadMedidaModel;
...
public class InventarioNuevoAjuste extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtProductoAutocompletado.setOnItemClickListener((adapterView, view, i, l) -> {
            productoSeleccionado = (Producto) txtProductoAutocompletado.getAdapter().getItem(i);
        });
    ...
    public void fullAutocompletadoProducto(){
        try {
            ...
            while (r.next()){
                productos.add(new Producto(r.getString("ProductoID"), r.getString("Nombre"), r.getString("Codigo"), r.getInt("Status")));
            }
            ArrayAdapter<Producto> arrayAdapter = new ArrayAdapter<Producto>(contexto, R.layout.support_simple_spinner_dropdown_item, productos);
