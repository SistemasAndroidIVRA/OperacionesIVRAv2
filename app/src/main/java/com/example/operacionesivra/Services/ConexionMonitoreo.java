package com.example.operacionesivra.Services;
...
public class ConexionMonitoreo {
    ...
    public Connection conexiondbImplementacion() {
        ...
        try {
            ...
            conexion = DriverManager.getConnection("jdbc:jtds:sqlserver://ivradns.ddns.net:1433;databaseName=Monitoreo;user=leonel;password=;");
